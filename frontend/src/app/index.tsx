...
//             <View>
//               <Text style={styles.headerTitle}>ጉዞ-ሼር <Text style={{color: '#38BDF8'}}>Guzo</Text></Text>
//               <Text style={styles.headerSubtitle}>PREMIER ETHIOPIAN TRANSIT NETWORK</Text>
//             </View>
//             <View style={styles.headerRight}>
//               <TouchableOpacity style={styles.langToggle} onPress={() => setLang(lang === 'en' ? 'am' : 'en')}>
//                 <Text style={styles.langText}>{lang === 'en' ? 'አማርኛ' : 'English'}</Text>
//               </TouchableOpacity>
//               {user && (
//                 <TouchableOpacity style={styles.logoutBtn} onPress={() => { setUser(null); setAuthView('welcome'); }}>
...
//                 <TouchableOpacity style={styles.glowPrimaryBtn} onPress={() => setAuthView('signin')}>
//                   <Text style={styles.glowPrimaryBtnText}>{currentText.signInNavBtn}</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity style={styles.glossSecondaryBtn} onPress={() => setAuthView('signup')}>
...
//               <TouchableOpacity onPress={() => setAuthView('welcome')} style={styles.backLink}>
...
//               <TouchableOpacity style={styles.glowPrimaryBtn} onPress={handleSignIn}>
...
//                 <TouchableOpacity style={[styles.roleCard3D, selectedRole === 'passenger' && styles.selectedRoleCard3D]} onPress={() => setSelectedRole('passenger')}>
//                   <Text style={[styles.roleText, selectedRole === 'passenger' && styles.selectedRoleText3D]}>{currentText.passengerRole}</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity style={[styles.roleCard3D, selectedRole === 'driver' && styles.selectedRoleCard3D]} onPress={() => setSelectedRole('driver')}>
//                   <Text style={[styles.roleText, selectedRole === 'driver' && styles.selectedRoleText3D]}>{currentText.driverRole}</Text>
//                 </TouchableOpacity>
//               </View>

//               <TouchableOpacity style={styles.glowPrimaryBtn} onPress={handleSignUp}>
...
//                 <TouchableOpacity style={[styles.tab3D, activeTab === 'feed' && styles.activeTab3D]} onPress={() => setActiveTab('feed')}>
//                   <Text style={[styles.tabText3D, activeTab === 'feed' && styles.activeTabText3D]}>{currentText.findRide}</Text>
//                 </TouchableOpacity>

//                 {user.role === 'passenger' && (
//                   <TouchableOpacity style={[styles.tab3D, activeTab === 'bookings' && styles.activeTab3D]} onPress={() => setActiveTab('bookings')}>
...
//                 {user.role === 'driver' && (
//                   <>
//                     <TouchableOpacity style={[styles.tab3D, activeTab === 'post' && styles.activeTab3D]} onPress={() => setActiveTab('post')}>
//                       <Text style={[styles.tabText3D, activeTab === 'post' && styles.activeTabText3D]}>{currentText.postTrip}</Text>
//                     </TouchableOpacity>
//                     <TouchableOpacity style={[styles.tab3D, activeTab === 'requests' && styles.activeTab3D]} onPress={() => setActiveTab('requests')}>
//                       <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6}}>
...
//                       <TouchableOpacity style={styles.glowPrimaryBtnSmall} onPress={() => fetchTrips(inputOrigin.trim(), inputDestination.trim())}>
//                         <Text style={styles.glowPrimaryBtnTextSmall}>{currentText.searchBtn}</Text>
//                       </TouchableOpacity>
//                       {(inputOrigin !== '' || inputDestination !== '') ? (
//                         <TouchableOpacity style={styles.glossSecondaryBtnSmall} onPress={() => { setInputOrigin(''); setInputDestination(''); fetchTrips('', ''); }}>
...
//                             <Text style={styles.routeText}>{item.origin} <Text style={{color: '#4F46E5'}}>➔</Text> {item.destination}</Text>
...
//                               <TouchableOpacity style={styles.actionBtnGlowDark} onPress={() => handleBookSeat(item.id, currentSeats)}>
...
//                             <TouchableOpacity style={styles.actionBtnCrimson} onPress={() => handleCompleteTrip(item.id)}>
...
//                         <Text style={styles.detailText}>💺 Seats Booked: <Text style={{fontWeight: '900', color: '#4F46E5'}}>{item.seatsBooked}</Text></Text>
...
//                             <TouchableOpacity style={styles.actionBtnEmerald} onPress={() => handleCallDriver(item.trip!.driver.phoneNumber)}>
//                               <Text style={styles.actionBtnTextLight}>{currentText.callDriverBtn}</Text>
//                             </TouchableOpacity>
//                             <TouchableOpacity style={styles.actionBtnIndigo} onPress={() => handleSendLocation(item.id)}>
...
//                         <Text style={styles.detailText}>💺 Seats Requested: <Text style={{fontWeight: '900', color: '#4F46E5'}}>{item.seatsBooked}</Text></Text>
...
//                             <TouchableOpacity style={styles.actionBtnAmber} onPress={() => handleOpenMap(item.pickupLat!, item.pickupLng!)}>
...
//                         {item.status === 'pending' && (
//                           <View style={styles.buttonActionGroup}>
//                             <TouchableOpacity style={styles.actionBtnEmerald} onPress={() => handleUpdateBookingStatus(item.id, 'confirmed')}>
//                               <Text style={styles.actionBtnTextLight}>{currentText.acceptBtn}</Text>
//                             </TouchableOpacity>
//                             <TouchableOpacity style={styles.actionBtnCrimson} onPress={() => handleUpdateBookingStatus(item.id, 'rejected')}>
...
//                   <TouchableOpacity style={styles.glowPrimaryBtn} onPress={handlePostTrip}>
...
//     overflow: 'hidden',
//     ...(Platform.OS === 'web' ? {
//       boxShadow: '0 30px 80px -10px rgba(79, 70, 229, 0.4)',
//       borderRadius: 40,
//       borderWidth: 6,
//       borderColor: '#1E293B',
//     } : {})
...
//     borderColor: '#C7D2FE' 
//   },
//   bannerText: { color: '#3730A3', fontWeight: '800', fontSize: 11, textAlign: 'center' },
...
//   heroTag: { fontSize: 9, fontWeight: '900', color: '#4F46E5', letterSpacing: 1.5, marginBottom: 8 },
...
//   backLinkText: { fontSize: 12, fontWeight: '800', color: '#4F46E5' },
...
//   selectedRoleCard3D: { backgroundColor: '#EEF2FF', borderColor: '#4F46E5' },
//   roleText: { fontSize: 12, fontWeight: '800', color: '#64748B' },
//   selectedRoleText3D: { color: '#4F46E5' },
//   glowPrimaryBtn: { backgroundColor: '#4F46E5', paddingVertical: 14, paddingHorizontal: 20, borderRadius: 14, alignItems: 'center', shadowColor: '#4F46E5', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 10, elevation: 6 },
...
//   glowPrimaryBtnSmall: { flex: 2, backgroundColor: '#4F46E5', paddingVertical: 10, borderRadius: 10, alignItems: 'center' },
...
//     ...(Platform.OS === 'web' ? {
//       boxShadow: '0 12px 30px -10px rgba(79, 70, 229, 0.12)',
//       transition: 'all 0.25s ease-in-out',
//       cursor: 'pointer',
//       ':hover': {
//         transform: 'translateY(-3px)',
//         boxShadow: '0 18px 40px -10px rgba(79, 70, 229, 0.25)',
//         borderColor: '#818CF8'
//       }
//     } : {})
//   } as any,
...
//   driverText: { color: '#4F46E5', fontSize: 11, marginTop: 4, fontWeight: '800' },
...
//   fareCalculatorHeader: { fontSize: 11, fontWeight: '900', color: '#4F46E5', marginBottom: 8, textTransform: 'uppercase' },
...
//   autoFillBtn: { backgroundColor: '#4F46E5', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
...
//   actionBtnEmerald: { flex: 1, backgroundColor: '#10B981', paddingVertical: 8, borderRadius: _getScaledRadius(8), alignItems: 'center' },
...
// function _getScaledRadius(val: number) {
//   return val;
// }
import React, { useState, useEffect } from 'react';
import { StyleSheet, Text, View, TextInput, TouchableOpacity, FlatList, ScrollView, Alert, SafeAreaView, Platform, Linking } from 'react-native';
